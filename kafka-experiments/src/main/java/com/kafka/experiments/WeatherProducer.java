...
public class WeatherProducer {
	...
	private static Logger logger = LoggerFactory.getLogger(WeatherProducer.class);
	...
	public static void main(String[] args) {
		...
		ProducerRecord<String, Double> producerRecord = new ProducerRecord<String, Double>(IKafkaConstants.WEATHER_TOPIC, 34.0d);
